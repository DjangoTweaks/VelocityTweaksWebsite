      ...
      <div className="container ml-3 md:mx-auto flex justify-around mt-12">
        <div className="w-4/5 md:w-3/5">
          <div className="w-inherit">
            <div className="text-xl mb-1 ml-1 ">Name</div>
            <div>
              <input
                type="text"
                className="border border-[#ADBDFF] focus:border-[#ADBDFF]  bg-black rounded-xl w-full md:w-3/5"
              ></input>
            </div>
            ...
            <div className="h-[400px] ">
              ...
              <div>
                <textarea
                  type="text"
                  className="border border-[#ADBDFF] focus:border-[#ADBDFF] bg-black h-[350px] md:h-[400px]  rounded-xl   w-[350px] md:w-4/5"
                ></textarea>{" "}
              </div>
            </div>
            <div className=" mt-2 md:mt-14">
              <button className="rounded-full px-2 py-1 w-[120px] text-xl bg-inherit border-white border hover:transition ease-in-out delay:150 hover:bg-[#212121] hover:transition duration-600 ease-in-out">
                Submit
              </button>
            </div>
          </div>
        ...
        <div className="w-2/5   ">
          ...
          >
            <g clip-path="url(#clip0_85_203)" filter="url(#filter0_d_85_203)">
              <path
            ...
            <defs>
              ...
              >
                <stop stop-color="#C0211E" />
                <stop offset="1" stop-color="#07A4FF" />
              </linearGradient>
