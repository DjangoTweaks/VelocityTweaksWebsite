        ...
        <div className="w-4/5 md:w-3/5">
          <div className="w-inherit">
            ...
            <div className=" mt-2 md:mt-14">
              <button className="rounded-full px-2 py-1 w-[120px] text-xl bg-inherit border-white border  hover:ease-in-out  hover:bg-[#212121] hover:transition duration-600 ease-in-out">
                Submit
              </button>
            </div>
          </div>
