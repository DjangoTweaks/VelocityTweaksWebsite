  ...
  return (
    ...
    >
      ...
      <div className="container  mx-auto md:pt-20 pt-10">
        ...
        <div className="text-white   block w-[670px] tracking-wider font-light text-xl	leading-9 font-Roboto md:pt-16 pt-16">
        ...
        <div className="flex">
          <Link to="store">
            <button className="text-white bg-[#FC2B27] transition-all ease-in duration-75 hover:bg-[#AB1D1A]  font-Inter font-medium text-lg rounded-full mt-36 h-16  w-40 p-3">
              Buy Now
            </button>
          </Link>

          <button className="text-white bg-black border border-white border-2 transition-all ease-in duration-75 hover:bg-[#1A1A1A]  text-lg font-Inter font-medium rounded-full ml-4 mt-36 h-16  w-40 p-3">
            Learn More
          </button>
        </div>
      </div>
